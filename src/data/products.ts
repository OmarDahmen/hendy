...
export const products: Product[] = [
  // Carnets Créatifs Personnalisés
  {
    ...
    description: 'Carnet personnalisé avec des illustrations colorées d\'animaux de la jungle. Parfait pour stimuler la créativité et l\'imagination des enfants.',
    price: 12.99,
  ...
  },
  {
    ...
    description: 'Carnet éducatif personnalisé pour découvrir les fruits et légumes de manière ludique et créative.',
    price: 12.99,
  ...
  // Kits Jouets Éducatifs
  {
    ...
    description: 'Kit complet pour créer son propre restaurant de pizzas. Développe la créativité et les compétences sociales.',
    price: 24.99,
  ...
  },
  {
    ...
    description: 'Kit de construction pour assembler sa propre maison. Stimule la motricité fine et la logique spatiale.',
    price: 29.99,
